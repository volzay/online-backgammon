-- Isolate short-bot v2 learning from v1 patterns whose phase and mistake
-- semantics were too broad and could penalize correct bear-off moves.
...
as $$
  ...
  select coalesce(jsonb_agg(jsonb_build_object(
    'creditVersion', 2, 'contextKey', context_key, 'actionKey', action_key,
