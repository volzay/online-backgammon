-- Isolate the v3 short-bot policy and its root-phase Pubeval descriptors
-- from older experience produced by materially different evaluators.
...
as $$
  ...
  select coalesce(jsonb_agg(jsonb_build_object(
    'creditVersion', 3, 'contextKey', context_key, 'actionKey', action_key,
