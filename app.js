...
(function () {
  ...
  const dicts = {
    ru: {
      ...
      change: 'Изменить',
      last_password_change: 'Последняя смена 14 дней назад',
    ...
    en: {
      ...
      change: 'Change',
      last_password_change: 'Last changed 14 days ago',
      ...
      accept_challenges: 'Accept challenges',
      accept_challenges_hint: 'Who can send you games',
      everyone: 'Everyone',
      friends: 'Friends',
      nobody: 'Nobody',
